...
$order_sql = "SELECT cart_code, customer_name, phone, cash, mfs, changeAmount FROM orders WHERE user_id = '$user_id' ORDER BY cart_code DESC LIMIT 1"; // Assuming order_id is the primary key
